...
# Axis = 0 será apagado as linhas e axis = 1 será apagado as colunas da base de dados
...
camada_oculta3 = Dense(units=32, activation='sigmoid')(camada_oculta2)
# Activation = linear indica que a rede não faz nada, apenas deixa passar o valor recebido
camada_saida1 = Dense(units=1, activation='linear')(camada_oculta3)
camada_saida2 = Dense(units=1, activation='linear')(camada_oculta3)
camada_saida3 = Dense(units=1, activation='linear')(camada_oculta3)
...
# loss encontrado: 4.7613
# loss encontrado: 4.1277 com mais uma camada escondida e 10000 épocas