...
Pode ser comparado com os resultados de apenas um previsor para ver qual gera melhor precisão
...
# Epoch 00077: ReduceLROnPlateau reducing learning rate to 6.400000529538374e-08.

# Epoch 00077: loss did not improve from 0.00074
