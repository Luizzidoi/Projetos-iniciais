...
regressor.fit(previsores, preco_real, epochs=130, batch_size=32)
...
with open('regressor_1Previsor_MultiSaidas.json', 'w') as json_file:
    json_file.write(regressor_json)

# Salvando os pesos da rede neural
regressor.save_weights('regressor_1Previsor_MultiSaida.h5')
...
# loss: 0.0015 - mean_absolute_error: 0.0284